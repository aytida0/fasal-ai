...
extension UserProfileQuerySortBy
  ...
  QueryBuilder<UserProfile, UserProfile, QAfterSortBy> sortByImagePath() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'imagePath', Sort.asc);
    });
  }

  QueryBuilder<UserProfile, UserProfile, QAfterSortBy> sortByImagePathDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension UserProfileQuerySortThenBy
  ...
  QueryBuilder<UserProfile, UserProfile, QAfterSortBy> thenByImagePath() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'imagePath', Sort.asc);
    });
  }

  QueryBuilder<UserProfile, UserProfile, QAfterSortBy> thenByImagePathDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'imagePath', Sort.desc);
    });
  }
...
extension UserProfileQueryWhereDistinct
  ...
  QueryBuilder<UserProfile, UserProfile, QDistinct> distinctByImagePath(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension UserProfileQueryProperty
  ...
  QueryBuilder<UserProfile, String?, QQueryOperations> imagePathProperty() {
    return QueryBuilder.apply(this, (query) {
